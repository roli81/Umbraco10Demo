...
namespace Sss.Umb9.Mutobo.PoCo
{
    public class Theme : PublishedElementModel, ITheme
    {
        ...
        public Theme(IPublishedElement content, IPublishedValueFallback publishedValueFallback) : base(content, publishedValueFallback)
        {
        ...
        public IHtmlContent GetDynamicCssProperties()
        {
            ...
            switch (PageTheme)
            {
                case EPageTheme.Classic:
                default:
                
                    break;
                case EPageTheme.Invert:
                    stringBuilder.AppendLine($"--background-color: var(--color);");
                    stringBuilder.AppendLine($"--color: var(--background-color);");
                    break;
